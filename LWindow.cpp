...
const int LWindow::SCREEN_WIDTH = 640;
...
LWindow::LWindow()
{
	if (SDL_Init(SDL_INIT_VIDEO) < 0) {
		...
		mWindow = SDL_CreateWindow("Asteroid Clone", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
		if (mWindow == NULL) {
